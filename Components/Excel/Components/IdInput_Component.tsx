                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex" dir='rtl'>
                            ...
                            <div className="flex space-x-2 " dir='ltr' data-hs-pin-input='{  "availableCharsRE": "^[0-9]+$"  }' id='uid' >
                                <input className="block border h-10 w-8 text-center border-gray-400 rounded-md text-sm placeholder:text-gray-300 focus:border-blue-500 focus:outline-blue-500 disabled:opacity-40 disabled:cursor-progress " type="text" placeholder="○" data-hs-pin-input-item disabled={loading} defaultValue={0} />
                                <input className="block border h-10 w-8 text-center border-gray-400 rounded-md text-sm placeholder:text-gray-300 focus:border-blue-500 focus:outline-blue-500 disabled:opacity-40 disabled:cursor-progress " type="text" placeholder="○" data-hs-pin-input-item disabled={loading} defaultValue={1} />
                                <input className="block border h-10 w-8 text-center border-gray-400 rounded-md text-sm placeholder:text-gray-300 focus:border-blue-500 focus:outline-blue-500 disabled:opacity-40 disabled:cursor-progress " type="text" placeholder="○" data-hs-pin-input-item disabled={loading} name="pin" id='uidFocusCell' />
                                <input className="block border h-10 w-8 text-center border-gray-400 rounded-md text-sm placeholder:text-gray-300 focus:border-blue-500 focus:outline-blue-500 disabled:opacity-40 disabled:cursor-progress " type="text" placeholder="○" data-hs-pin-input-item disabled={loading} name="pin" />
                                <input className="block border h-10 w-8 text-center border-gray-400 rounded-md text-sm placeholder:text-gray-300 focus:border-blue-500 focus:outline-blue-500 disabled:opacity-40 disabled:cursor-progress " type="text" placeholder="○" data-hs-pin-input-item disabled={loading} name="pin" />
                                <input className="block border h-10 w-8 text-center border-gray-400 rounded-md text-sm placeholder:text-gray-300 focus:border-blue-500 focus:outline-blue-500 disabled:opacity-40 disabled:cursor-progress " type="text" placeholder="○" data-hs-pin-input-item disabled={loading} name="pin" />
                                <input className="block border h-10 w-8 text-center border-gray-400 rounded-md text-sm placeholder:text-gray-300 focus:border-blue-500 focus:outline-blue-500 disabled:opacity-40 disabled:cursor-progress " type="text" placeholder="○" data-hs-pin-input-item disabled={loading} name="pin" />
                                <input className="block border h-10 w-8 text-center border-gray-400 rounded-md text-sm placeholder:text-gray-300 focus:border-blue-500 focus:outline-blue-500 disabled:opacity-40 disabled:cursor-progress " type="text" placeholder="○" data-hs-pin-input-item disabled={loading} name="pin" />
