                                    ...
                                    <>
                                        <div className="col-span-2 sm:col-span-1">
                                            ...
                                            <input type="number" name="nbr_elvs" value={newLevelStat.nbr_elvs} onChange={handle_change}
                                                className="bg-gray-50 border text-right border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-blue-600 focus:border-primary-600 block w-full p-2.5 " />
                                        </div>
                                        <div className="col-span-2 sm:col-span-1">
