...
const Excel2 = () => {
    ...
    class CustomRowComponent {
        ...
        constructor(initialValue: string) {
            ...
            this.rowElement.classList.add('bg-slate-50 hover:bg-slate-400 border-b border-black  h-8');
    ...
    function addCustomRow(newRowValue: string) {
        
        const customRow = new CustomRowComponent(newRowValue);
        const rowElement = customRow.getRowElement();

        // Append the custom row to the table
